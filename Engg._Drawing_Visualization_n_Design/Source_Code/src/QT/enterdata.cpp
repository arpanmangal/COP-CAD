                                                  ...
                                                  ui(new Ui::EnterData)
{
    ...
    this->mode = (mode == 2) ? 2 : 3;
     ...
     QString instruction = ("<h3>Enter Data for " + type + " </h3>" +
                            "Please enter point set and edge set for the " + type + "<br>after clicking 'Enter Data' <br>");
//     ui->InstructionLabel->setText(instruction);

//     setupButtons();
//     ui->Main3DLayout->destroyed(ui->ContinueButton);
//     delete ui->ContinueButton;
     delete ui->Main3DLayout;
}
...
// void EnterData::on_pushButton_clicked()
// {

// }
void EnterData::setupButtons()
{
...
void EnterData::on_ContinueButton_clicked()
{

}

void EnterData::on_enterPoint_clicked()
{

}

void EnterData::on_finishPointAddition_clicked()
{
    ui->enterPoint->setEnabled(false);
    ui->finishPointAddition->setEnabled(false);
}

void EnterData::on_enterEdge_clicked()
{

}

void EnterData::on_finishEdgeAddition_clicked()
{
